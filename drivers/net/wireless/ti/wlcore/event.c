...
extern ktime_t audio_sync_ktime_target;
...
void wlcore_event_clock_sync(struct wl1271 *wl, u32 clock)
{
	...
	// schedule hr timer 49.8ms after arrival of the beacon to WiLink8
	ktime = ktime_add_ns(audio_sync_gpio_ktime, 1000*(49800-(clock-audio_sync_beacon_timestamp)));
	audio_sync_ktime_target = ktime_add_ns(audio_sync_gpio_ktime, 1000*(50000-(clock-audio_sync_beacon_timestamp)));
